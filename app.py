...
def MontaDicionario(dado):
    ...
    dicio['user']['user_fields']['cliente_atendimento_alocacao'] = str(dado[chaves_inversas['cliente_atendimento_alocacao']])
    ...
    print(dicio['user']['user_fields']['cliente_atendimento_alocacao'])
